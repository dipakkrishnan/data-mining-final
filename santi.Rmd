...
library(ada)
colnames(trainR)
rand.fit = randomForest(review_scores_rating~., data = trainR[,-c(1,2)], ntree = 500, na.action=na.exclude)
...
# misClasificError <- mean(rand.predictions != testR$review_scores_rating[-nas])
# print(paste('Accuracy',1-misClasificError))
