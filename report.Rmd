...
of prediction strength were $\it{cleaning\_fee}$ and $\it{host\_listings\_count}$. Interestingly, the variables we
added for location mapping were among the best predictors in the feature set. Our model
